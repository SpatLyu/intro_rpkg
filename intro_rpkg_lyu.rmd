...
.pull-right[
<img src="./assets/pkgs_lyu.png" style="margin-top: 120px; width: 80%; height: auto;" />
]
...
```{r world1,out.height="50%",out.width="50%",fig.width=4.5,fig.height=2.5}
library(sf)
library(geocn)
library(ggplot2)
...
```{r world2,out.height="50%",out.width="50%",fig.width=4.5,fig.height=2.5}
library(sf)
library(geocn)
library(ggplot2)
